...
# 00 07 * * * cd ~/EntertainmentGraph/src && RUN_FRIENDSHIPS=1 ./prioritized_dashboard_creation.sh > ~/cron.log 2>&1
# Run daily at 5pm EST (17:00 EST, 21:00 UTC)
# 00 21 * * * cd ~/EntertainmentGraph/src && RUN_FRIENDSHIPS=0 ./prioritized_dashboard_creation.sh > ~/cron.log 2>&1
...
if [ $RUN_FRIENDSHIPS == 1 ]
  then
    ...
    mongo gt-db-roll-frame-s0-a/gt-roll-frame -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/mr_roll.js
  else
...
mongo gt-db-user-action-s0-b/gt-user-action -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/mr_user_action.js
...
mongo gt-db-dashboard-s0-a/gt-dashboard-entry -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/mr_dashboard_entry.js
...
mongo localhost/gt-prioritized-dashboard -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/mr_prioritized_dashboard_intermediary.js
...
mongo localhost/gt-prioritized-dashboard -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/reset_side_prioritized_dashboard.js
echo ">>>Create temporary PrioritizedDashbaord (4 concurrent processes) ..."
mongo localhost/gt-prioritized-dashboard -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/generate_side_prioritized_dashboard.js &
mongo localhost/gt-prioritized-dashboard -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/generate_side_prioritized_dashboard.js &
mongo localhost/gt-prioritized-dashboard -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/generate_side_prioritized_dashboard.js &
mongo localhost/gt-prioritized-dashboard -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/generate_side_prioritized_dashboard.js &
...
mongo localhost/admin -u 'gt_user' -p 'GT/us3r!!!' ~/EntertainmentGraph/src/big_data/atomic_update_prioritized_dashboard.js
echo ">>>Done!"
